const translations = {
  ...
  world_delete_confirm: { cn: "确定删除这个世界？所有模拟存档、事件和数据将被彻底删除，不可恢复。", en: "Delete this world? All simulation saves, events, and data will be permanently deleted." },
  ...
  total: { cn: "个", en: "Total" },
  highlights: { cn: "重大", en: "KEY" },
  chronicle: { cn: "编年", en: "CHRONICLE" },
  view_timeline: { cn: "时间线", en: "TIMELINE" },
  chronicle_empty: { cn: "运行世界以生成编年史", en: "Run the world to generate chronicle" },
  chapter_writing: { cn: "// 正在撰写章节...", en: "// Writing chapter..." },
  durable: { cn: "持久", en: "DURABLE" },
  sig_axis_goal: { cn: "目标", en: "goal" },
  sig_axis_social: { cn: "社交", en: "social" },
  sig_axis_state: { cn: "状态", en: "state" },
  sig_axis_resource: { cn: "资源", en: "resource" },
  sig_axis_world: { cn: "世界", en: "world" },
  sig_axis_information: { cn: "信息", en: "info" },
  sig_axis_ambient: { cn: "环境", en: "ambient" },
  verb_observe: { cn: "观察", en: "OBSERVE" },
  verb_nudge: { cn: "注入事件", en: "INJECT" },
  verb_direct: { cn: "接管角色", en: "DIRECT" },
  verb_fork: { cn: "分叉时间线", en: "FORK" },
  oracle_btn: { cn: "ORACLE", en: "ORACLE" },
  hint_oracle: { cn: "全知叙述者 — 询问世界", en: "Omniscient narrator — ask about the world" },
  hint_nudge: { cn: "向世界注入一个事件", en: "Inject an event into the world" },
  hint_direct: { cn: "手动控制角色行动", en: "Take manual control of a character" },
  hint_fork: { cn: "从当前时间点创建分支", en: "Branch from current timeline" },
  report: { cn: "报告", en: "REPORT" },
  report_title: { cn: "世界报告", en: "WORLD REPORT" },
  report_overview: { cn: "总览", en: "OVERVIEW" },
  report_milestones: { cn: "里程碑", en: "MILESTONES" },
  report_agent_arcs: { cn: "角色弧线", en: "AGENT ARCS" },
  report_social: { cn: "社会动态", en: "SOCIAL DYNAMICS" },
  report_axis: { cn: "重要性分布", en: "SIGNIFICANCE AXES" },
  report_actions: { cn: "行动分布", en: "ACTION BREAKDOWN" },
  report_total_events: { cn: "总事件", en: "TOTAL EVENTS" },
  report_significant: { cn: "关键事件", en: "SIGNIFICANT" },
  report_durable: { cn: "持久事件", en: "DURABLE" },
  report_sig_ratio: { cn: "信噪比", en: "SIGNAL RATIO" },
  report_alive: { cn: "存活", en: "ALIVE" },
  report_dead: { cn: "死亡", en: "DEAD" },
  report_alliances: { cn: "同盟", en: "ALLIANCES" },
  report_rivalries: { cn: "对立", en: "RIVALRIES" },
  report_none: { cn: "暂无", en: "NONE" },
  report_goal: { cn: "目标", en: "GOAL" },
  report_stalled: { cn: "停滞", en: "STALLED" },
  report_key_events: { cn: "关键事件", en: "KEY EVENTS" },
  report_close: { cn: "关闭", en: "CLOSE" },
  report_loading: { cn: "生成报告中…", en: "GENERATING REPORT…" },
  report_error: { cn: "报告生成失败", en: "REPORT FAILED" },
  ...
  ph_agent_goal: { cn: "角色目标", en: "Agent goal" },
  ...
  fork_failed: { cn: "// FORK_ERR — 分叉失败，可能无快照", en: "// FORK_ERR — Fork failed. No snapshot may exist at this tick." },
  ...
  edit_agent: { cn: "编辑角色", en: "Edit Agent" },
  ...
  goal_strategy: { cn: "策略 //", en: "STRATEGY //" },
  goal_next_step: { cn: "下一步 //", en: "NEXT //" },
  rel_trust: { cn: "信任", en: "TRUST" },
  rel_tension: { cn: "张力", en: "TENSION" },
  ...
  // Command bar
  cmd_placeholder: { cn: "输入指令...", en: "Type a command..." },
  cmd_send: { cn: "发送", en: "Send" },
  cmd_thinking: { cn: "思考中...", en: "Thinking..." },
  cmd_error: { cn: "指令执行失败", en: "Command failed" },
