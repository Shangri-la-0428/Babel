  ...
  switch (type) {
    case "agent":
      return (
        <div className="flex flex-col gap-3">
          ...
          <DataField label={t("goals_label")} value={data.goals as string[]} />
    ...
    case "world":
      return (
        <div className="flex flex-col gap-3">
          <DataField label={t("description")} value={data.description as string} />
          <DataField label={t("rules_label")} value={data.rules as string[]} />
          ...
          <DataField label={t("initial_events_label")} value={data.initial_events as string[]} />
        </div>
      );
    default:
      return (
