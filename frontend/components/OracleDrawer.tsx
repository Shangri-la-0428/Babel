    ...
    >
      ...
      <form onSubmit={handleSubmit} className="flex items-end gap-2 p-4 border-t border-b-DEFAULT shrink-0 relative overflow-hidden">
        ...
        <ExpandableInput
          ...
          className="flex-1 min-w-0 h-9 px-3 bg-void border border-b-DEFAULT text-detail text-t-DEFAULT normal-case tracking-normal focus:border-primary focus:outline-none hover:border-b-hover transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
          onKeyDown={(e) => {
